...
class AccountSpec extends Specification {
  ...
  "Account" should {
    ...
    "insert a new account2" in new WithApplication {
      val json = Json.obj(
    ...
    "prevent duplicate creation" in new WithApplication {
      val json = Json.obj(
    ...
    "technical_name and name are mandatory" in new WithApplication {
      val json = Json.obj()
